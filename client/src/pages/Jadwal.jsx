...
const Jadwal = () => {
  ...
  const handleSlotSelect = async (slot) => {
    try {
      setRescheduleLoading(true);
      // Calculate week number for the selected date using local date parsing
      const eventDate = parseLocalDate(slot.date);
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-center">
                    <h2 className="text-lg font-semibold text-gray-900">
                      {getMonday(currentDate).toLocaleDateString("id-ID", {
                        day: "numeric",
                        month: "long",
                      })}{" "}
                      -{" "}
                      {new Date(
                        getMonday(currentDate).getTime() +
                          4 * 24 * 60 * 60 * 1000
                    ...
                    <p className="text-sm text-gray-500">
                      Minggu ke-
                      {Math.ceil(
                        (currentDate - parseLocalDate("2024-08-26")) /
                          (7 * 24 * 60 * 60 * 1000)
                      )}
                    </p>
                  </div>
                    ...
                    <div className="grid grid-cols-5 gap-1 relative">
                      {weekDays.map((day, dayIdx) => (
                        <div
                          ...
                          style={{
                            minHeight: `${
                              (END_HOUR - START_HOUR) * ROW_HEIGHT
                            }px`,
                          }}
                        >
                          {/* Schedule items */}
                          ...
                          >
                            {day.classes?.map((cls, clsIdx) => {
                              console.log(
                                `🎯 Rendering class for day ${day.dayName}:`,
                                cls
                              );
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 font-medium">
                    {selectedEvent.room_code || "Belum ditentukan"}
                  </span>
                </div>
              </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-500 mt-1">
                      Temukan slot waktu yang kosong
                    </span>
                  </button>
                  <button

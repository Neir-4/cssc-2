...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!form.role) {
      setError("Pilih peran Anda: Komting atau Mahasiswa.");
      return;
    }
              ...
              <div className="border border-yellow-300 rounded-md overflow-hidden mt-1">
                <div className="flex text-sm text-center">
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 px-2 py-2 ${
                      form.role === "mahasiswa"
                        ? "bg-yellow-300 text-[#243e36]"
                        : "bg-transparent"
                    }`}
                  >
                    <input
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 px-2 py-2 border-l border-yellow-300 ${
                      form.role === "komting"
                        ? "bg-yellow-300 text-[#243e36]"
                        : "bg-transparent"
                    }`}
